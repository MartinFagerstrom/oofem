...
#define DofIDItem_DEF \
  ...
  \
    ...
    ENUM_ITEM_WITH_VALUE(m_u, 31) /* u-component of director field (in direction of x-axis) */ \
	ENUM_ITEM_WITH_VALUE(m_v, 32) /* v-component of director field (in direction of y-axis) */ \
	ENUM_ITEM_WITH_VALUE(m_w, 33) /* w-component of director field (in direction of z-axis) */ \
